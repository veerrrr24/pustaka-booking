...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 28, 2022 at 03:15 AM
...
(1, 'Statistika dengan Program Komputer', 1, 'Ahmad Kholiqul AMin', 'Deep Publish', 2014, '9786022809432', 6, 1, 1, 'img1557408455.jpg'),
...
CREATE TABLE `kategori` (
  ...
  `nama_kategory` varchar(45) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `kategori` (`id_kategory`, `nama_kategory`) VALUES
(1, 'Komputer'),
(2, 'Bahasa'),
(3, 'Sains'),
(4, 'Hobby'),
